...
public class BluetoothMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMakeDiscoverable.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(BluetoothMainActivity.this, "Device is now discoverable for 300 seconds", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void findViewsByIds() {
        ...
        msgBody = findViewById(R.id.editTextMessage);
        View btnSend = findViewById(R.id.btn_send);

        btnSend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (msgBody.getText().toString().equals("")) {
                    Toast.makeText(BluetoothMainActivity.this, "Please input some texts", Toast.LENGTH_SHORT).show();
                } else {
                    //TODO: here
                    sendMessage(msgBody.getText().toString());
                    msgBody.setText("");
                }
            }
        });
